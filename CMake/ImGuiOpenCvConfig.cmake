...
if (NOT USE_LOCAL_OPENCV_PACKAGE)
    if (WIN32)
        ...
        endforeach()
        file(COPY "${OpenCV_DIR}/../bin/usb-ma2x8x.mvcmd" DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/")
        file(COPY "${OpenCV_DIR}/../bin/pcie-ma2x8x.elf" DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/")
        file(COPY "${OpenCV_DIR}/../bin/plugins.xml" DESTINATION "${CMAKE_CURRENT_BINARY_DIR}/")
    else()
